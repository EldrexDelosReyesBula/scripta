 ...
 * 
 * Manages local file saving via the modern File System Access API (Chromium)
 * with robust fallbacks to standard Blob file downloads and localStorage session backing.
 * Scripta never transmits user work to remote servers or third-party cloud services.
 */
...
export class StorageEngine {
  ...
  /**
   * Serialize current state into the standard .scripta JSON format.
   */
  ...
  /**
   * Save session snapshot to localStorage to protect against accidental crashes.
   */
  ...
  /**
   * Save to disk using File System Access API if available, else download as blob.
   */
  ...
  /**
   * Load .scripta file from local disk via native picker or hidden input element.
   */
  async openProject() {
  ...
  /**
   * Helper to trigger native file downloads for exports (.txt, .md, .html).
   */
